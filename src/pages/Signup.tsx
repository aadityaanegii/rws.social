  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-[#09090b] text-zinc-200">
        ...
        >
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className="text-zinc-500">Get started with your free account</p>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-[#0f1015] p-12 border-l border-white/5">
         {/* Same abstract graphic as login */}
         <div className="max-w-md text-center space-y-6">
          <div className="aspect-square rounded-3xl bg-white/[0.02] border border-white/5 flex items-center justify-center mb-8 relative overflow-hidden backdrop-blur-3xl shadow-2xl">
             <div className="absolute top-1/4 right-1/4 w-40 h-40 bg-indigo-600/20 rounded-full blur-3xl"></div>
             <div className="absolute bottom-1/4 left-1/4 w-40 h-40 bg-violet-600/20 rounded-full blur-3xl"></div>
          ...
          <p className="text-zinc-500 text-lg">Connect with friends, share moments, and chat in realtime.</p>
        </div>
      </div>
    </div>
  );
